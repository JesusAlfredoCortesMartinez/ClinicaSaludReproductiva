<%@ Page Title="Formulario Diagnóstico" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ForDiagnostico.aspx.cs" Inherits="ClinicaReproductiva5701.ForDiagnostico" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="background-color: pink; padding: 20px; border-radius: 10px;">
        ...
        <asp:TextBox ID="txtIdDiagnostico" runat="server" placeholder="ID Diagnóstico" ReadOnly="true" /><br /><br />
