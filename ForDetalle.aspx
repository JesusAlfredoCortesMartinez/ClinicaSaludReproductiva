<%@ Page Title="Formulario Detalle Tratamiento" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ForDetalle.aspx.cs" Inherits="ClinicaReproductiva5701.ForDetalle" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="background-color: pink; padding: 20px; border-radius: 10px;">
        <h2>Formulario Detalle Tratamiento</h2>

        <asp:TextBox ID="txtIdDetalleTratamiento" runat="server" placeholder="ID Detalle Tratamiento" ReadOnly="true" /><br /><br />
        <asp:TextBox ID="txtIdTratamiento" runat="server" placeholder="ID Tratamiento" /><br /><br />
        <asp:TextBox ID="txtFrecuencia" runat="server" placeholder="Frecuencia" /><br /><br />
        <asp:TextBox ID="txtDuracionDias" runat="server" placeholder="Duración en días" /><br /><br />
        <asp:TextBox ID="txtInstrucciones" runat="server" placeholder="Instrucciones específicas" /><br /><br />
