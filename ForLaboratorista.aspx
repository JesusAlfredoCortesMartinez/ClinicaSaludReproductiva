<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ForLaboratorista.aspx.cs" Inherits="ClinicaReproductiva5701.ForLaboratorista" %>
...
<div style="background-color: pink; padding: 20px; border-radius: 10px;">
    <h2>Formulario Laboratorista</h2>

    <asp:TextBox ID="txtIdLaboratorista" runat="server" placeholder="Id  Laboratorista" ReadOnly="true" /><br /><br />
    <asp:TextBox ID="txtNombre" runat="server" placeholder="Usuario" /><br /><br />
