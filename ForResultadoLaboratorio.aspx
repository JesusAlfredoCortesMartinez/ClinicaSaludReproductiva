<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ForResultadoLaboratorio.aspx.cs" Inherits="ClinicaReproductiva5701.ForResultadoLaboratorio" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <div style="background-color: pink; padding: 20px; border-radius: 10px;">
      <h2>Formulario Resultado Laboratorio</h2>

      <asp:TextBox ID="txtIdResultado" runat="server" placeholder="Id Resultado" ReadOnly="true" /><br /><br />
      <asp:TextBox ID="txtTipoEstudio" runat="server" placeholder="Tipo Estudio" /><br /><br />
      <asp:TextBox ID="txtResultado" runat="server" placeholder="Resultado" /><br /><br />
      <asp:TextBox ID="txtFecha" runat="server" placeholder="Fecha" DataFormatString="{0:yyyy-MM-dd}" /><br /><br />
      <asp:TextBox ID="txtIdPaciente" runat="server" placeholder="Id Paciente" /><br /><br />
      <asp:TextBox ID="txtIdLaboratorista" runat="server" placeholder="Id Laboratorista" /><br /><br />
