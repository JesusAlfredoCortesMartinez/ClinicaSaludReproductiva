<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ForConsultorio.aspx.cs" Inherits="ClinicaReproductiva5701.ForConsultorio" %>
...
<div style="background-color: pink; padding: 20px; border-radius: 10px;">
    <h2>Formulario Consultorio</h2>

    <asp:TextBox ID="txtIdConsultorio" runat="server" placeholder="ID Consultorio" ReadOnly="true" /><br /><br />
    <asp:TextBox ID="txtNombre" runat="server" placeholder="Nombre" /><br /><br />
    <asp:TextBox ID="txtUbicacion" runat="server" placeholder="Ubicacion" /><br /><br />
