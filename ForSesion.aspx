<%@ Page Title="Formulario Sesión" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ForSesion.aspx.cs" Inherits="ClinicaReproductiva5701.ForSesion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="background-color: pink; padding: 20px; border-radius: 10px;">
        <h2>Formulario Sesión</h2>

        <asp:TextBox ID="txtIdSesion" runat="server" placeholder="ID Sesión" ReadOnly="true" /><br /><br />
        <asp:TextBox ID="txtIdPaciente" runat="server" placeholder="ID Paciente" /><br /><br />
        <asp:TextBox ID="txtIdPsicologo" runat="server" placeholder="ID Psicólogo" /><br /><br />
