<%@ Page Title="Formulario Procedimiento" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ForProcedimiento.aspx.cs" Inherits="ClinicaReproductiva5701.ForProcedimiento" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="background-color: pink; padding: 20px; border-radius: 10px;">
        <h2>Formulario Procedimiento</h2>

        <asp:TextBox ID="txtIdProcedimiento" runat="server" placeholder="ID Procedimiento" ReadOnly="true" /><br /><br />
        <asp:TextBox ID="txtIdTratamiento" runat="server" placeholder="ID Tratamiento" /><br /><br />
        <asp:TextBox ID="txtNombre" runat="server" placeholder="Nombre del Procedimiento" /><br /><br />
        <asp:TextBox ID="txtDescripcion" runat="server" placeholder="Descripción" TextMode="MultiLine" Rows="3" /><br /><br />
        <asp:TextBox ID="txtFecha" runat="server" placeholder="Fecha (yyyy-mm-dd)" /><br /><br />
