<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TratamientoDoc.aspx.cs" Inherits="ClinicaReproductiva5701.TratamientoDoc1" %>
...
<div class="contenedor">
    <h2>Tabla Tratamiento</h2>

    <!-- 🧠 Esto permite scroll horizontal en móviles sin romper el diseño -->
    <div class="tabla-responsiva">
        <asp:GridView ID="gvTratamientos" runat="server" AutoGenerateColumns="False" DataKeyNames="IdTratamiento" OnRowCommand="gvTratamientos_RowCommand" HeaderStyle-BackColor="#cccccc" HeaderStyle-ForeColor="Black" RowStyle-BackColor="White" AlternatingRowStyle-BackColor="#f2f2f2" CssClass="gridview-estilo">
            <Columns>
                <asp:ButtonField Text="Ver" CommandName="Ver" ButtonType="Button" />
                <asp:BoundField DataField="IdTratamiento" HeaderText="ID Tratamiento" />
