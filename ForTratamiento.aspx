<%@ Page Title="Formulario Tratamiento" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ForTratamiento.aspx.cs" Inherits="ClinicaReproductiva5701.ForTratamiento" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="background-color: pink; padding: 20px; border-radius: 10px;">
        <h2>Formulario Tratamiento</h2>

        <asp:TextBox ID="txtIdTratamiento" runat="server" placeholder="ID Tratamiento" ReadOnly="true" /><br /><br />
        <asp:TextBox ID="txtNombre" runat="server" placeholder="Nombre" /><br /><br />
        <asp:TextBox ID="txtDescripcion" runat="server" placeholder="Descripcion" /><br /><br />
        <asp:TextBox ID="txtFechaInicio" runat="server" placeholder="Fecha de inicio (yyyy-mm-dd)" /><br /><br />
        <asp:TextBox ID="txtFechaFin" runat="server" placeholder="Fecha de fin (yyyy-mm-dd)" /><br /><br />
