<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MedicoAdmin.aspx.cs" Inherits="ClinicaReproductiva5701.MedicoAdmin" %>
...
<div class="contenedor">
    ...
    <div class="tabla-responsiva">
        <asp:GridView ID="gvMedico" runat="server" AutoGenerateColumns="False" DataKeyNames="IdMedico" OnRowCommand="gvMedico_RowCommand" HeaderStyle-BackColor="#cccccc" HeaderStyle-ForeColor="Black" RowStyle-BackColor="White" AlternatingRowStyle-BackColor="#f2f2f2" CssClass="gridview-estilo">
            <Columns>
