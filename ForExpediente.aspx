<%@ Page Title="Formulario Expediente" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ForExpediente.aspx.cs" Inherits="ClinicaReproductiva5701.ForExpediente" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="background-color: pink; padding: 20px; border-radius: 10px;">
        <h2>Formulario Expediente</h2>

        <asp:TextBox ID="txtIdExpediente" runat="server" placeholder="ID Expediente" ReadOnly="true" /><br /><br />
        <asp:TextBox ID="txtHistorialClinico" runat="server" placeholder="Historial Clínico" TextMode="MultiLine" Rows="4" /><br /><br />
