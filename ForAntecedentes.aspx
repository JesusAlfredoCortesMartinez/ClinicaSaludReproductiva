<%@ Page Title="Formulario Antecedentes" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ForAntecedente.aspx.cs" Inherits="ClinicaReproductiva5701.ForAntecedente" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <asp:Label ID="Label1" runat="server" Visible="false" />
    ...
    <div style="background-color: pink; padding: 20px; border-radius: 10px;">
        <h2>Formulario Antecedente</h2>

        <asp:TextBox ID="txtIdAntecedente" runat="server" placeholder="ID Antecedente" ReadOnly="true" /><br /><br />
        <asp:TextBox ID="txtIdExpediente" runat="server" placeholder="ID Expediente" /><br /><br />
        <asp:TextBox ID="txtTipo" runat="server" placeholder="Tipo de antecedente" /><br /><br />
        <asp:TextBox ID="txtDescripcion" runat="server" placeholder="Descripción" /><br /><br />
        <asp:TextBox ID="txtGravedad" runat="server" placeholder="Gravedad" /><br /><br />
        <asp:TextBox ID="txtFechaRegistro" runat="server" placeholder="Fecha (yyyy-mm-dd)" /><br /><br />
