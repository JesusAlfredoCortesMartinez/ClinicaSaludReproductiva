<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ForPago.aspx.cs" Inherits="ClinicaReproductiva5701.ForPago" %>
...
<div style="background-color: pink; padding: 20px; border-radius: 10px;">
    <h2>Formulario Pago</h2>

    <asp:TextBox ID="txtIdPago" runat="server" placeholder="Id Pago" ReadOnly="true" /><br /><br />
    <asp:TextBox ID="txtMonto" runat="server" placeholder="Monto" /><br /><br />
    <asp:TextBox ID="txtFecha" runat="server" placeholder="Fecha" DataFormatString="{0:yyyy-MM-dd}" /><br /><br />
    <asp:TextBox ID="txtMetodoPago" runat="server" placeholder="Metodo de Pago" /><br /><br />
    <asp:TextBox ID="txtIdTratamiento" runat="server" placeholder="Tratamiento" /><br /><br />
