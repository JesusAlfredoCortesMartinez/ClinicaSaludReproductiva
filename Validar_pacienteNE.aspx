<%@ Page Title="Ingreso" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Validar_pacienteNE.aspx.cs" Inherits="ClinicaReproductiva5701.Validar_pacienteNE" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   <style>
    ...
    <div class="container">
        <h2>Ingrese CURP para entrar</h2>
        ...
        <asp:Button ID="btnCrearCuenta" runat="server" Text="Crear cuenta" CssClass="button btn-crear" OnClick="btnCrearCuenta_Click" />
